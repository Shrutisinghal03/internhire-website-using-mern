...
const PostJob = () => {
  ...
  const handleJobPost = async (e) => {
    ...
    try {
      const res = await axios.post("http://localhost:4000/api/job/addpost", jobData, {
          ...
          <form onSubmit={handleJobPost}>
            <div className="wrapper">
              ...
              >
               ...
               <option value="" disabled option> Select jobType</option>
   ...
   <option value="part-time">partTime</option>
            ...
            />
             <input
              type="number"
              value={Expierience}
              onChange={(e) => setExpierience(e.target.value)}
              placeholder="Expierince in years"
            />
